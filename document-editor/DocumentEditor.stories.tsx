...
import { FilterType } from "@maticonoffice/docspace-api-sdk";
...
export const FillSpreadsheetWithData: Story = {
  render: (args: StoryArgs) => {
    ...
    const fillSpreadsheetData = () => {
      // @ts-ignore - DocEditor is provided by MATICONOFFICE at runtime
      const documentEditor = window.DocEditor?.instances?.[args.id];
      ...
      try {
        ...
        // @ts-ignore - Asc.scope is provided by MATICONOFFICE connector API
        ...
        connector.callCommand(() => {
          ...
          // @ts-ignore - Api is provided by MATICONOFFICE connector API
