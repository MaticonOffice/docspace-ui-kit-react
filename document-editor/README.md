...
A React wrapper component for integrating Maticon Office Document Editor into your application. Provides a seamless way to embed document editing capabilities with full configuration support.
...
| `documentServerUrl`     | `string`                                                      |    ✅    |    -    | URL of the Maticon Office Document Server                                       |
...
The `config` prop accepts an `IConfig` object that follows the Maticon Office Document Server API specification. Key configuration sections include:
...
For complete configuration options, refer to the [Maticon Office API Documentation](https://api.maticonoffice.ru/editors/config/).
