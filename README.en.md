...
> React UI component library extracted from the [Maticon Office DocSpace client](https://github.com/MaticonOffice/DocSpace-client) codebase.

[![React](https://img.shields.io/badge/react-%3E%3D19.0.0-blue)](https://react.dev)

## About This Library

`@docspace/ui-kit` provides React components and a color system extracted from the [DocSpace-client monorepo](https://github.com/MaticonOffice/DocSpace-client) (`libs/ui-kit`).
...
| [ApiProvider](./providers/api/README.md) | Creates React Context with `profilesApi` and `commonSettingsApi` from `@maticonoffice/docspace-api-sdk` |
...
Clone this repository or work within the [DocSpace-client monorepo](https://github.com/MaticonOffice/DocSpace-client) and run:
...
| Resource | URL |
|----------|-----|
| 🌐 Maticon Office Website | [maticonoffice.ru](https://www.maticonoffice.ru) |
| 🐙 DocSpace-client Monorepo | [github.com/MaticonOffice/DocSpace-client](https://github.com/MaticonOffice/DocSpace-client) |
| 📖 Maticon Office API | [api.maticonoffice.ru](https://api.maticonoffice.ru) |
| 💬 Community Forum | [community.maticonoffice.ru](https://community.maticonoffice.ru) |
| 🆘 Help Center | [help.maticonoffice.ru](https://help.maticonoffice.ru) |
| 📣 Feedback | [feedback.maticonoffice.ru](https://feedback.maticonoffice.ru/forums/966080-your-voice-matters) |

## Contributing

Issues and feature requests are tracked in the [DocSpace-client repository](https://github.com/MaticonOffice/DocSpace-client/issues). Contributions are welcome - please open an issue or PR there, or start a discussion on the [community forum](https://community.maticonoffice.ru).
