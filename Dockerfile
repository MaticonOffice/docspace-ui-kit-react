...
COPY packages/client/maticonoffice-docspace-plugin-sdk-*.tgz ./packages/client/
COPY packages/client/maticonoffice-docspace-sdk-js-*.tgz ./packages/client/
COPY packages/shared/package.json ./packages/shared/package.json
COPY libs/ui-kit/package.json ./libs/ui-kit/package.json
COPY libs/ui-kit/maticonoffice-docspace-api-sdk-*.tgz ./libs/ui-kit/
